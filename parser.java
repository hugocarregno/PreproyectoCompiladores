...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Oct 08 12:26:03 ART 2024
  */
...
RESULT = new Arbol(temp, e1, e2);
    ...
    parser.lista3d.add(new Codigo3D(Etiqueta.SUMA,e1.getInfo(),e2.getInfo(),temp));
		...
		Arbol ep = (Arbol)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                  ...
                  Simbolo temp = new Simbolo(Etiqueta.DECLS);
                  parser.lista3d.add(new Codigo3D(Etiqueta.DECLS,el.getInfo(),ep.getInfo(),temp));
                  RESULT = new Arbol(temp, el, ep); 
