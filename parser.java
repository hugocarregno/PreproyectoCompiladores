...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Oct 30 00:00:49 ART 2024
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  public int error_sym() {return 1;}
    ...
    public static ArrayList<String> lineasCodigo = new ArrayList<>();
...
if (e1.getInfo().getTipo() != Tipos.BOOL || e2.getInfo().getTipo() != Tipos.BOOL) {
     ...
     parser.lineasCodigo.add(Codigo3D.generarLinea(Etiqueta.OR,e1.getInfo(),e2.getInfo(),temp));
...
if (e1.getInfo().getTipo() != Tipos.BOOL || e2.getInfo().getTipo() != Tipos.BOOL) {
     ...
     Simbolo temp = new Simbolo(Etiqueta.AND,"&&",Tipos.BOOL,e1.getInfo().getValor() * e2.getInfo().getValor() ==1 ? 1 : 0 ,aleft);
      ...
      parser.lineasCodigo.add(Codigo3D.generarLinea(Etiqueta.AND,e1.getInfo(),e2.getInfo(),temp));
...
Simbolo temp = new Simbolo(Etiqueta.MULT,"*",Tipos.INT,e1.getInfo().getValor()*e2.getInfo().getValor(),tleft);
      ...
      parser.lineasCodigo.add(Codigo3D.generarLinea(Etiqueta.MULT,e1.getInfo(),e2.getInfo(),temp));
...
RESULT = new Arbol(temp, e1, e2);
    ...
    parser.lineasCodigo.add(Codigo3D.generarLinea(Etiqueta.SUMA,e1.getInfo(),e2.getInfo(),temp));
    parser.lista3d.add(new Codigo3D(Etiqueta.SUMA,e1.getInfo(),e2.getInfo(),temp));
          ...
          case 10: // expr_part ::= RETURN SEMI 
            {
              ...
              parser.lineasCodigo.add(Codigo3D.generarLinea(Etiqueta.RETURN,null,null,temp));
		...
		Arbol e = (Arbol)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 System.out.println("resultado:"+e.getInfo().getValor());
              ...
              parser.lineasCodigo.add(Codigo3D.generarLinea(Etiqueta.RETURN,null,e.getInfo(),temp));
        ...
        parser.lineasCodigo.add(Codigo3D.generarLinea(Etiqueta.ASIGNACION,new Arbol(simbolo).getInfo(),e.getInfo(),temp));
