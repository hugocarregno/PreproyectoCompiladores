...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Sep 20 14:10:15 ART 2024
  */
...
RESULT = new Arbol(new Simbolo(Etiqueta.OR,"||",Tipos.BOOL,0,oleft), e1, e2);
...
RESULT = new Arbol(new Simbolo(Etiqueta.AND,"&&",Tipos.BOOL,0,aleft), e1, e2);
...
RESULT = new Arbol(new Simbolo(Etiqueta.MULT,"*",Tipos.INT,0,tleft), e1, e2);
		...
		RESULT = new Arbol(new Simbolo(Etiqueta.SUMA,"+",Tipos.INT,0,pleft), e1, e2);
